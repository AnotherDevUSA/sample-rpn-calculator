...
function Display(z) {
  ...
  // currentnum method - return currented displayed number
  this.currentnum = function ()
  {
    return self.dom.innerHTML
  }

  // setcurrentnum method - set displayed number to t
  ...
  // chs method - Change sign of currently displayed number
  this.chs = function () {
  ...
  // clear method - Clear currently displayed number (set to 0)
  this.clear = function () {
  ...
  // bspace method -
  // Delete (Backspace) rightmost char if in the process of
  // of entering a number, otherwise clear display
  ...
  // num method - enter character (number or decimal point),
  // modifying display.
  this.num = function (o)
  {
    if (self.iscomplete == true) {
  ...
  // enter method - push currently displayed number
